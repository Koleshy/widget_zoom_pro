...
class WidgetZoomProFullscreen extends StatefulWidget {
  ...
  @override
  State<WidgetZoomProFullscreen> createState() => _ImageZoomFullscreenState();
}

class _ImageZoomFullscreenState extends State<WidgetZoomProFullscreen>
          ...
          child: Align(
            ...
            child: MouseRegion(
              ...
              child: GestureDetector(
                ...
                child: AnimatedOpacity(
                  duration: _opacityDuration * 0.25,
                  opacity: _opacity,
                  child: const Padding(
